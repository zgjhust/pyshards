# Django settings for djangoconf project.
...
DATABASE_NAME = 'shardconf'             # Or path to database file if using sqlite3.
...
SECRET_KEY = '(@tz@8^a0n_8ta$^55#ly6y(a-u4_x3b(4)nwkwl#&kzj_0rou'
